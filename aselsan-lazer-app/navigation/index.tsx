...
export default function Navigation({
  ...
  return (
    <NavigationContainer
      ref={(navigationRef) => {
        if (navigationRef) {
          IStore.navigation = navigationRef;
        }
      }}
    ...
    >
      <BottomTab.Screen
        ...
        options={({ navigation, route }) => ({
          tabBarLabel: (
            <FontText title={string.olcum2} size={1.1} bold position="center" />
          ),
          tabBarIcon: ({ focused, color }) => (
            <CImage
              source={require("../assets/images/goz.png")}
              width={4}
              height={4}
            />
          ),
      ...
      <BottomTab.Screen
        ...
        options={({ navigation, route }) => ({
          tabBarLabel: (
            <FontText title={string.cihaz2} size={1.1} bold position="center" />
          ),
          tabBarIcon: ({ focused, color }) => (
            <CImage
              source={require("../assets/images/cihaz2.png")}
              width={4}
              height={4}
            />
          ),
      ...
      <BottomTab.Screen
        ...
        options={({ navigation, route }) => ({
          ...
          tabBarIcon: ({ focused, color }) => (
            <CImage
              source={require("../assets/images/yapilandirici.png")}
              width={4}
              height={4}
            />
          ),
      ...
      <BottomTab.Screen
        ...
        options={({ navigation, route }) => ({
          ...
          tabBarIcon: ({ focused, color }) => (
            <CImage
              source={require("../assets/images/lazer.png")}
              width={4}
              height={4}
            />
          ),
  ...
  return (
    <CView padding="2 0 1 2" onPress={() => navigation.navigate("MoreInfo")}>
      <CImage
        ...
        height={8}
        resizeMode={"stretch"}
        source={require("../assets/images/dahafazla.png")}
      />
    </CView>
  );
}
