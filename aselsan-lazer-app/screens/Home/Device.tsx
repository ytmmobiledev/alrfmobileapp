...
function Device({ navigation }: any) {
    ...
    return (
        <Container style={{backgroundColor:Colors.darkGray}} >
            <CView padding="3 3 3 1"  width="100%" row vertical="center" horizontal="space-between">
                ...
                >
                    <MaterialCommunityIcons name="reload" size={hp(3)} color={Colors.white} />
                    ...
                    <CView padding="1" width="80%" radius={10} color="secondary">

                        {
                            ...
                            Object.entries(usage_params).map(([key,{title}])=>{
                                ...
                                return (
                                    <CView key={key} margin="1" padding="1" style={{borderStyle:'dashed', borderWidth:1,borderRadius:1,borderColor:'#667587'}}>
                                                            ...
                                                            <CView row vertical="center" horizontal="space-between" key={index}>
                                                                <FontText flex={2} position="left" padding="1" title={title} size={1.6} bold/>
                                                                {
                                                                    value?
                                                                        ...
                                                                        <ActivityIndicator style={{flex:1,height:hp(1),alignItems:'flex-end',padding:hp(1)}} color="#667587" size="small"  />
                                                                }
                                                            </CView>
                                                        ))
                                                        :
