    ...
    <CView center color={"darkGray"} vertical="center" flex={1}>
      ...
      <CView flex={9} width={"100%"}>
        <CImage
          style={{ flex: 8 }}
          resizeMode="contain"
          source={require("../../assets/images/devices/bg.png")}
          orgWidth={"100%"}
          background
        >
          <CView flex={1} center>
            <CView onPress={() => {}}>
              <CImage
                resizeMode="contain"
                source={require("../../assets/images/devices/button.png")}
                width={26}
                height={26}
              />
            </CView>
        ...
        <FontText
          flex={1}
          position="center"
          title={"cevrenizdekicihazlariaramayabaslayin"}
          size={2.2}
          bold
          color={"text"}
        />
